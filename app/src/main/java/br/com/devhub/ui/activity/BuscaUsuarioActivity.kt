...
class BuscaUsuarioActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        var usuarioBuscado by mutableStateOf("")
            ...
            DevHubTheme {
                ...
                Surface(
                    ...
                    if (usuarioBuscado.isEmpty()) {
                        BuscaUsuarioScreen(onUsuarioBuscado = { usuario ->
                            usuarioBuscado = usuario
                        })
                    } else {
                        PerfilUsuarioScreen(usuarioBuscado)
                    }
                }
            }
        }
